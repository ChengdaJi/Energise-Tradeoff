...
df_cost = DataFrame(SEM=Integer[], pen_25=Float64[],
    pen_50=Float64[], pen_75=Float64[], pen_100=Float64[])
df_power = DataFrame(SEM=Integer[], pen_25=Float64[],
    pen_50=Float64[], pen_75=Float64[], pen_100=Float64[])
...
for b_cap in B_cap
    ...
    for p in p_rate
        ...
        folder = string(folder, "p_rate/p_rate_", Integer(p*100), "/");
        filename = string(filename, "p_rate_", Integer(p*100), "_");
        folder = string(folder, "b_cap/b_cap_", Integer(sem*1000), "/")
        filename = string(filename, "b_cap_", Integer(sem*1000), "_")
