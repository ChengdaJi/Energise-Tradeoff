...
# max solar error
solar_error_max = [0.025, 0.1, 0.2, 0.5, 0.75, 1.0, 2.0];
...
mkpath("./results_1014/analysis/")
CSV.write("./results_1014/analysis/sem_table_cost.csv", df_cost)
CSV.write("./results_1014/analysis/sem_table_power.csv", df_power)
