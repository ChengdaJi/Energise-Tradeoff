...
sem_p75_cost = (M(1:3,1) - deters(1))/ deters(1)*100;
sem_p100_cost = (M(1:3,2) - deters(2))/deters(2)*100;
...
sem_p75_solar = M(1:3,3) ./ deters(3);
sem_p100_solar = M(1:3,4) ./ deters(4);
...
cc_p75_cost = (M(9:11,1) - deters(1))/ deters(1)*100;
cc_p100_cost = (M(9:11,2) - deters(2))/deters(2)*100;
...
cc_p75_solar = M(9:11,3) ./ deters(3);
cc_p100_solar = M(9:11,4) ./ deters(4);
